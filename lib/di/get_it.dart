...
Future init() async {
  ...
  getItInstance.registerLazySingleton<MusicRemoteSource>(() => MusicRemoteSourceImpl(getItInstance()));

  getItInstance.registerLazySingleton<MusicRemoteRepository>(() => MusicRemoteRepositoryImpl(getItInstance()));

  getItInstance.registerLazySingleton<GetTracksFromChart>(() => GetTracksFromChart(getItInstance()));
  getItInstance.registerLazySingleton<GetTrackDetails>(() => GetTrackDetails(getItInstance()));
  getItInstance.registerLazySingleton<GetTrackLyrics>(() => GetTrackLyrics(getItInstance()));

  getItInstance.registerFactory<HomeBloc>(() => HomeBloc(getTracksFromChart: getItInstance()));
  getItInstance.registerFactory<TrackDetailsBloc>(() => TrackDetailsBloc(getTrackLyrics: getItInstance(),getTrackDetails: getItInstance()));
